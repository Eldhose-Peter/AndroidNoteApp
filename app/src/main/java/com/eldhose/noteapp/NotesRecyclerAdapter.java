...
public class NotesRecyclerAdapter extends FirestoreRecyclerAdapter<notes, NotesRecyclerAdapter.NoteViewHolder> {

    NoteListener noteListener;

    public NotesRecyclerAdapter(@NonNull FirestoreRecyclerOptions<notes> options,NoteListener noteListener) {
       super(options);
    ...
    protected void onBindViewHolder(@NonNull NoteViewHolder holder, int position, @NonNull notes model) {
            ...
            CharSequence dateCharSeq= DateFormat.format("EEEE, MMM d,yyyy h:mm:ss a",model.getDateCreated().toDate());
            holder.timeTextView.setText(dateCharSeq);
    ...
    class NoteViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView noteTextView,timeTextView;
        CheckBox checkBox;
        public NoteViewHolder(@NonNull View itemView) {
            ...
            checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    ...
                    notes note = getItem(getAdapterPosition());
                    if(note.getCompleted()!=b)
                        noteListener.handleCheckChanged(b,snapshot);
                }
            });
